import sys
sys.modules['audioop'] = None  # Patch for Python 3.13
...
# Slash command: Set scanner interval
...
# Slash command: Set custom log message
...
# Slash command: List members with vanity
